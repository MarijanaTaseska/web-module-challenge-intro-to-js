...
let firstThing = 'Bad Dog'
let secondThing = 'Good Dog'

if (secondThing === 'Good Dog') {
  firstThing = "Not Bad Dog";
} else {
 firstThing = 'Bad Dog'
}
...
*/
const NewYear = '1999';
console.log('task1c', Number(NewYear));
...
console.log('task1d', multiply(8,5));
...
console.log('task3', hungryDog(16,0.5));
console.log('task3', hungryDog(4,0.75));
